...
<form:form method="post" action="addNewPatient.html" commandName="patient">
<br/>
<div id="page">
	<!-- start content -->
	<div id="content">
...
<div class="post">
<h1 class="title">Emergency Contact Information</h1>
...
<div class="post">
<h1 class="title">
User Account Details</h1>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>User Id: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="accountBean.userName"/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Password: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:password path="accountBean.password"/><br/>
